...
import { useAuthStore, MOCK_USERS, Role } from "@/store/auth-store";
...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      let role: Role = "clinic";
      if (emailLower.includes("student")) role = "student";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link href="/register" className="text-crosshere hover:text-crosshere/80 font-medium transition-colors">
          Create account
        </Link>
      </motion.p>
    </motion.div>
